...
caption: Plugin
githubUrl: https://github.com/theakashshukla/repo-name
npmUrl: https://www.npmjs.com/package/some-package
layout: Project
---
...
See the [configuration](https://github.com/theakashshukla/theakashshukla.ghithub.io/blob/a6078ba395ea65cc9c1a7ea524adb29b9580406d/apps/theakash/tailwind.config.js#L54-L57) file and [implementation](https://github.com/theakashshukla/theakashshukla.github.io/blob/a6078ba395ea65cc9c1a7ea524adb29b9580406d/apps/theakash/src/providers/ColorAccentProvider.tsx#L18-L20) code for details.
