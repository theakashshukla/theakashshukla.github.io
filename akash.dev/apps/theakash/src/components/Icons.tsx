...
export function AiIcon(props: ComponentProps<'svg'>) {
  return (
    ...
    >
      <title>AI Icon</title>
      <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm-.001 22.5c-5.799 0-10.5-4.701-10.5-10.5S6.2 1.5 12 1.5s10.5 4.701 10.5 10.5-4.701 10.5-10.501 10.5z" />
    </svg>
  );
}
